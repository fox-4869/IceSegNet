...
from .Alberta_river_ice_segmentation_dataset import Alberta_river_ice_segmentation_dataset
...
__all__ = [
    ...
    'SynapseDataset', 'NWPU_YRCC', 'NWPU_YRCC2_JPG1',
    'Alberta_river_ice_segmentation_dataset', 'archive'
]
