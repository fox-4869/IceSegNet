...
test_dataloader = dict(
    ...
    dataset=dict(
        data_prefix=dict(
            img_path='NWPU_YRCC2_JPG1/val',
            seg_map_path='NWPU_YRCC2_JPG1/val_labels'),
        data_root='../../../data/',
        pipeline=[
...
train_cfg = dict(max_iters=60000, type='IterBasedTrainLoop', val_interval=250)
train_dataloader = dict(
    batch_size=4,
    dataset=dict(
        data_prefix=dict(
            img_path='NWPU_YRCC2_JPG1/train',
            seg_map_path='NWPU_YRCC2_JPG1/train_labels'),
        data_root='../../../data/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations'),
...
work_dir = './work_dirs/NWPUYRCC2JPG1-IceSegNet_2*3090_60000'
